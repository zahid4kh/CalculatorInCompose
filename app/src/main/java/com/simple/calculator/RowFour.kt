...
//        Button(onClick = { buttonClear = !buttonClear}, shape = MaterialTheme.shapes.extraLarge) {
...
//        }
//        Button(onClick = {buttonEquals = !buttonEquals}, shape = MaterialTheme.shapes.extraLarge) {
